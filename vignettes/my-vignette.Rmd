...
All our functions use the same arguments in order to maintain simplicity. You have three components `function()`, `data`, `"column"`, and `method` (found in the `bol_imputer` and `date_imputer` functions). This is shown below.

    function(data_frame, "column_name", method = 'method')
